	...
	render: function () {
		...
		var goersNodes = this.props.firebaseGoersList.map(function (theGoer, i) {
			if (theGoer.status == 'pending') {
				...
				return React.createElement(GoersListItem, { goer: goer, accessId: that.props.accessId, key: i });
			}
		});
...
var GoersListItem = React.createClass({
	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				'a',
				{ href: this.props.goer.profileImageURL },
				React.createElement('img', { src: this.props.goer.profileImageURL, style: { width: '36px', height: '36px' } })
			),
...
var ChatWindow = React.createClass({
	...
	render: function () {
		...
		var messageNodes = this.props.chatWindowData.map(function (message, i) {
			return React.createElement(Message, { currentUserId: that.props.currentUserId, username: message.username, key: i, userId: message.userId, message: message.msg, avatar: message.profileImgUrl });
		});
		return React.createElement(
			'div',
